...
parser.add_argument('--cat', type=str, default='A',
                    choices=['A', 'B', 'C', 'D'])
parser.add_argument('--dx', type=int, default=5, choices=[5, 10, 15, 20, 25])
parser.add_argument('--dy', type=int, default=5, choices=[5, 10, 15, 20, 25])
parser.add_argument('--dz', type=int, default=5, choices=[5, 10, 15, 20, 25])
parser.add_argument('--num_th', type=int, default=20, choices=[20])
